...
class TestInlineMarkdown(unittest.TestCase):
    ...
    def test_extract_markdown_multiple_images(self):
        matches = extract_markdown_images("This is text with an ![image](https://i.imgur.com/zjjcJKZ.png) and another ![image2](https://i.imgur.com/zjjcJKZ2.png)")
    ...
    def extract_markdown_links(self):
        matches = extract_markdown_links("This is text with a ![link](https://www.bootdev.com)")
        self.assertListEqual([("link", "https://www.bootdev.com")], matches)

    def extract_markdown_multiple_links(self):
        matches = extract_markdown_links("This is text with a [link](https://www.boot.dev) and [another link](https://blog.boot.dev)")
        self.assertListEqual([("link", "https://www.bootdev.com"), ("another link", "https://blog.boot.dev")], matches)
